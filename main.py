...
'''
ARD.write(str.encode("|S"+hw_info['CPU']))
ARD.write(str.encode("|N"+str(hw_info['Clock'])))
ARD.write(str.encode("|A"+str(hw_info['Load'])))
ARD.write(str.encode("|A"+str(hw_info['Temp'])))
ARD.write(str.encode("|N"+hw_info['MB'][9:]))
ARD.write(str.encode("|N"+str(hw_info['Fan1'])))
ARD.write(str.encode("|A"+str(hw_info['DDC_Pump'])))
